...
import static com.vivalahm.couponcore.exception.ErrorCode.INVALID_COUPON_ISSUE_DATE;
import static com.vivalahm.couponcore.exception.ErrorCode.INVALID_COUPON_ISSUE_QUANTITY;
...
class CouponTest {
    ...
    @Test
    @DisplayName("발급 기간에 해당되는 경우 true를 반환한다.")
    ...
    void Issue_1() {
        ...
        //then
        Assertions.assertEquals(100, coupon.getIssuedQuantity());
    ...
    @Test
    @DisplayName("발급 기간이 유효하지 않다면 예외를 발생한다..")
    void Issue_3() {
        //given
        Coupon coupon = Coupon.builder()
                .totalQuantity(100)
